...
表设计的重点不是把字段全部写进数据库，而是让数据结构能够准确表达业务对象之间的关系。

主键解决“如何唯一定位一条记录”的问题，外键解决“表与表之间如何关联”的问题，约束解决“哪些数据不应该被写入”的问题。掌握这些基础后，再学习索引、事务和查询优化时会更容易理解数据库为什么能保证数据一致性，以及为什么某些查询能够高效执行。
